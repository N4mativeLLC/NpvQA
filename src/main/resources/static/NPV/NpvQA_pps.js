...
function getTableData(){
	...
	var table= $('#QAtable').DataTable( {
	    ...
	    columnDefs: [
	 	...
	 	columns: [
	        { title: "Member",data: 'MemberNumber'  },
	        { title: "Customer Name" ,data:'FirstName'},
			{ title: "Age Group" ,data:'Age_group'},
	        { title: "ProfShareAlloc",data:'ProfitShare_Amount_Display' },
			{ title: "PotentialProfShare",data:'Potential_ProfitShare_Amount_Display' },
			{ title: "2019 Closing Bal" ,data:'2019_Closing_Bal_Display'},
			{ title: "Operating Profit",data:'Operating_profit_Display' },
	        { title: "Investment Returns",data:'Investment_returns_Display' },
	        { title: "2020 Profit Share",data:'2020_prof_share_balance_Display' },
	        { title: "Life_Risk" ,data:'PPS_Life_Risk'},
	        { title: "Investments" ,data:'PPS_Investments'},
			{ title: "Short-term" ,data:'PPS_short_term_Insurance'},
	        { title: "Prof_Med" ,data:'PPS_Prof_Med'},
			{ title: "Health Prof" ,data:'Medical_Health_Professional'},
			{ title: "Profit_member" ,data:'Profit_member'},
	        { title: "Advisor" ,data:'financial_advisor'},
	        { title: "Advisor Email" ,data:'advisor_email'},
	...
	$('#QAtable tbody').on( 'click', 'tr', function (){ 
		...
		customer_id = table.row(this).data()['MemberNumber'];
		customer_name = table.row(this).data()['FirstName'];
